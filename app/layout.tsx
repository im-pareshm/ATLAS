...
export const metadata: Metadata = {
  ...
  description: "Personal finance worksheet: plan what's due, tick off what's paid, know the cash left.",
};

// Runs before paint: applies stored theme (or system preference) to avoid a flash.
